 ...
 */
#include "nsconfig.h"
#if defined(HAVE_6LOWPAN_ND) || defined(TI_WISUN_FAN_OPT_ICMPV6)
#include "ns_types.h"
#include "string.h"
...
#endif //HAVE_6LOWPAN_ND || TI_WISUN_FAN_OPT_ICMPV6
...
#if (defined(HAVE_IPV6_ND) && defined(HAVE_6LOWPAN_ROUTER)) || defined (TI_WISUN_FAN_OPT_ICMPV6)
