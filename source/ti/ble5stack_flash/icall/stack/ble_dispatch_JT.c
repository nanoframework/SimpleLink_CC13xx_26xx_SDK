...
const uint32_t bleAPItable[] =
{
...
#if defined(CTRL_CONFIG) && (CTRL_CONFIG & (ADV_CONN_CFG | ADV_NCONN_CFG))
...
#else // !((ADV_CONN_CFG | ADV_NCONN_CFG))
  (uint32)icall_liteErrorFunction,
  (uint32)icall_liteErrorFunction,
  (uint32)icall_liteErrorFunction,
  (uint32)icall_liteErrorFunction,
  ...
  (uint32)icall_liteErrorFunction,
  (uint32)icall_liteErrorFunction,
#endif // ADV_CONN_CFG | ADV_NCONN_CFG
...
(uint32)icall_liteErrorFunction,
  ...
  (uint32)GAP_UpdateLinkParamReq,                            // JT_INDEX[164]
  (uint32)GAP_TerminateLinkReq,                              // JT_INDEX[165]
  (uint32)GAP_UpdateLinkParamReqReply,                       // JT_INDEX[166]
  (uint32)GAP_Gap_RegisterConnEventCb,                       // JT_INDEX[167]
  ...
  (uint32)GapAdv_create,                                     // JT_INDEX[168]
  (uint32)GapAdv_destroy,                                    // JT_INDEX[169]
  (uint32)GapAdv_enable,                                     // JT_INDEX[170]
  (uint32)GapAdv_disable,                                    // JT_INDEX[171]
  (uint32)GapAdv_setParam,                                   // JT_INDEX[172]
  (uint32)GapAdv_getParam,                                   // JT_INDEX[173]
  (uint32)GapAdv_getBuffer,                                  // JT_INDEX[174]
  (uint32)GapAdv_loadByHandle,                               // JT_INDEX[175]
  (uint32)GapAdv_loadByBuffer,                               // JT_INDEX[176]
  (uint32)GapAdv_prepareLoadByHandle,                        // JT_INDEX[177]
  (uint32)GapAdv_prepareLoadByBuffer,                        // JT_INDEX[178]
  (uint32)GapAdv_setEventMask,                               // JT_INDEX[179]
  (uint32)GapAdv_abortLoad,                                  // JT_INDEX[180]
  (uint32)GapAdv_setVirtualAdvAddr,                          // JT_INDEX[181]
  (uint32)GapAdv_SetPeriodicAdvParams,                       // JT_INDEX[182]
  (uint32)GapAdv_SetPeriodicAdvData,                         // JT_INDEX[183]
  (uint32)GapAdv_SetPeriodicAdvEnable,                       // JT_INDEX[184]
  ...
  (uint32)GapScan_registerCb,                                // JT_INDEX[185]
  (uint32)GapScan_setPhyParams,                              // JT_INDEX[186]
  (uint32)GapScan_getPhyParams,                              // JT_INDEX[187]
  (uint32)GapScan_setParam,                                  // JT_INDEX[188]
  (uint32)GapScan_getParam,                                  // JT_INDEX[189]
  (uint32)GapScan_setEventMask,                              // JT_INDEX[190]
  (uint32)GapScan_enable,                                    // JT_INDEX[191]
  (uint32)GapScan_disable,                                   // JT_INDEX[192]
  (uint32)GapScan_getAdvReport,                              // JT_INDEX[193]
  (uint32)GapScan_discardAdvReportList,                      // JT_INDEX[194]
  (uint32)GapScan_PeriodicAdvCreateSync,                     // JT_INDEX[195]
  (uint32)GapScan_PeriodicAdvCreateSyncCancel,               // JT_INDEX[196]
  (uint32)GapScan_PeriodicAdvTerminateSync,                  // JT_INDEX[197]
  (uint32)GapScan_SetPeriodicAdvReceiveEnable,               // JT_INDEX[198]
  (uint32)GapScan_AddDeviceToPeriodicAdvList,                // JT_INDEX[199]
  (uint32)GapScan_RemoveDeviceFromPeriodicAdvList,           // JT_INDEX[200]
  (uint32)GapScan_ReadPeriodicAdvListSize,                   // JT_INDEX[201]
  (uint32)GapScan_ClearPeriodicAdvList,                      // JT_INDEX[202]
  ...
  (uint32)GapInit_setPhyParam,                               // JT_INDEX[203]
  (uint32)GapInit_getPhyParam,                               // JT_INDEX[204]
  (uint32)GapInit_connect,                                   // JT_INDEX[205]
  (uint32)GapInit_connectWl,                                 // JT_INDEX[206]
  (uint32)GapInit_cancelConnect,                             // JT_INDEX[207]
...
#if defined(HOST_CONFIG)
  (uint32)GAP_TerminateAuth,                                 // JT_INDEX[208]
  (uint32)GAP_Authenticate,                                  // JT_INDEX[209]
  (uint32)GAP_PasskeyUpdate,                                 // JT_INDEX[210]
  (uint32)GAP_Signable,                                      // JT_INDEX[211]
  (uint32)GAP_Bond,                                          // JT_INDEX[212]
  (uint32)GAP_SetPrivacyMode,                                // JT_INDEX[213]
#else // !(defined(HOST_CONFIG))
  (uint32)icall_liteErrorFunction,
  (uint32)icall_liteErrorFunction,
  (uint32)icall_liteErrorFunction,
  ...
  (uint32)GAP_SendSlaveSecurityRequest,                      // JT_INDEX[214]
#else // !(HOST_CONFIG & PERIPHERAL_CFG)
  (uint32)icall_liteErrorFunction,
#endif // (HOST_CONFIG & PERIPHERAL_CFG)
  (uint32)RTLSSrv_init,                                      // JT_INDEX[215]
  (uint32)RTLSSrv_register,                                  // JT_INDEX[216]
  (uint32)RTLSSrv_setConnCteReceiveParams,                   // JT_INDEX[217]
  (uint32)RTLSSrv_setConnCteTransmitParams,                  // JT_INDEX[218]
  (uint32)RTLSSrv_setConnCteRequestEnableCmd,                // JT_INDEX[219]
  (uint32)RTLSSrv_setConnCteResponseEnableCmd,               // JT_INDEX[220]
  (uint32)RTLSSrv_readAntennaInformationCmd,                 // JT_INDEX[221]
  (uint32)RTLSSrv_setCteSampleAccuracy,                      // JT_INDEX[222]
  (uint32)RTLSSrv_initAntArray,                              // JT_INDEX[223]
  (uint32)RTLSSrv_SetCLCteTransmitParams,                    // JT_INDEX[224]
  (uint32)RTLSSrv_CLCteTransmitEnable,                       // JT_INDEX[225]
  (uint32)RTLSSrv_setCLCteSamplingEnableCmd,                 // JT_INDEX[226]
#if defined(HOST_CONFIG)
  (uint32)L2CAP_ConnParamUpdateReq,                          // JT_INDEX[227]
  (uint32)L2CAP_ParseParamUpdateReq,                         // JT_INDEX[228]
  (uint32)L2CAP_ParseInfoReq,                                // JT_INDEX[229]
#else // !defined(HOST_CONFIG)
  (uint32)icall_liteErrorFunction,
  (uint32)icall_liteErrorFunction,
  (uint32)icall_liteErrorFunction,
  ...
  (uint32)L2CAP_RegisterPsm,                                 // JT_INDEX[230]
  (uint32)L2CAP_DeregisterPsm,                               // JT_INDEX[231]
  (uint32)L2CAP_PsmInfo,                                     // JT_INDEX[232]
  (uint32)L2CAP_PsmChannels,                                 // JT_INDEX[233]
  (uint32)L2CAP_ChannelInfo,                                 // JT_INDEX[234]
  (uint32)L2CAP_SendSDU,                                     // JT_INDEX[235]
  (uint32)L2CAP_ConnectReq,                                  // JT_INDEX[236]
  (uint32)L2CAP_ConnectRsp,                                  // JT_INDEX[237]
  (uint32)L2CAP_DisconnectReq,                               // JT_INDEX[238]
  (uint32)L2CAP_FlowCtrlCredit,                              // JT_INDEX[239]
...
#if ( HOST_CONFIG & ( CENTRAL_CFG | PERIPHERAL_CFG ))
  (uint32)L2CAP_RegisterFlowCtrlTask,                        // JT_INDEX[240]
#else // !( HOST_CONFIG & ( CENTRAL_CFG | PERIPHERAL_CFG ) )
  (uint32)icall_liteErrorFunction,
#endif // ( HOST_CONFIG & ( CENTRAL_CFG | PERIPHERAL_CFG ) )
#if ( defined(HOST_CONFIG) && ( defined(HCI_TL_FULL) && ( !defined(GATT_DB_OFF_CHIP) && defined(TESTMODES) )))
  (uint32)L2CAP_SetParamValue,                               // JT_INDEX[241]
  (uint32)L2CAP_GetParamValue,                               // JT_INDEX[242]
#else // !( defined(HOST_CONFIG) && ( defined(HCI_TL_FULL) && ( !defined(GATT_DB_OFF_CHIP) && defined(TESTMODES))  ))
  (uint32)icall_liteErrorFunction,
  (uint32)icall_liteErrorFunction,
#endif // ( defined(HOST_CONFIG) && ( defined(HCI_TL_FULL) && ( !defined(GATT_DB_OFF_CHIP) && defined(TESTMODES))  ))
#if ( defined(HOST_CONFIG) && ( defined(HCI_TL_FULL)  ))
  (uint32)L2CAP_InfoReq,                                     // JT_INDEX[243]
#else // !( defined(HOST_CONFIG) && ( defined(HCI_TL_FULL)  ))
  (uint32)icall_liteErrorFunction,
#endif // ( defined(HOST_CONFIG) && ( defined(HCI_TL_FULL)  ))
#if defined(HOST_CONFIG)
  (uint32)GATT_Indication,                                   // JT_INDEX[244]
  (uint32)GATT_Notification,                                 // JT_INDEX[245]
#else // !defined(HOST_CONFIG)
  (uint32)icall_liteErrorFunction,
  (uint32)icall_liteErrorFunction,
#endif // defined(HOST_CONFIG)
#if ( HOST_CONFIG & ( CENTRAL_CFG | PERIPHERAL_CFG ))
  (uint32)GATT_RegisterForMsgs,                              // JT_INDEX[246]
  (uint32)GATT_UpdateMTU,                                    // JT_INDEX[247]
  (uint32)GATT_SendRsp,                                      // JT_INDEX[248]
  (uint32)GATT_SetHostToAppFlowCtrl,                         // JT_INDEX[249]
  (uint32)GATT_AppCompletedMsg,                              // JT_INDEX[250]
#else // !( HOST_CONFIG & ( CENTRAL_CFG | PERIPHERAL_CFG ) )
  (uint32)icall_liteErrorFunction,
  (uint32)icall_liteErrorFunction,
  (uint32)icall_liteErrorFunction,
  ...
  (uint32)GATT_InitClient,                                   // JT_INDEX[251]
  (uint32)GATT_RegisterForInd,                               // JT_INDEX[252]
  ...
  (uint32)GATT_ExchangeMTU,                                  // JT_INDEX[253]
  (uint32)GATT_DiscAllPrimaryServices,                       // JT_INDEX[254]
  (uint32)GATT_DiscPrimaryServiceByUUID,                     // JT_INDEX[255]
  (uint32)GATT_DiscAllChars,                                 // JT_INDEX[256]
  (uint32)GATT_DiscCharsByUUID,                              // JT_INDEX[257]
  (uint32)GATT_DiscAllCharDescs,                             // JT_INDEX[258]
  (uint32)GATT_ReadCharValue,                                // JT_INDEX[259]
  (uint32)GATT_ReadUsingCharUUID,                            // JT_INDEX[260]
  (uint32)GATT_ReadLongCharValue,                            // JT_INDEX[261]
  (uint32)GATT_ReadMultiCharValues,                          // JT_INDEX[262]
  (uint32)GATT_WriteNoRsp,                                   // JT_INDEX[263]
  (uint32)GATT_SignedWriteNoRsp,                             // JT_INDEX[264]
  (uint32)GATT_WriteCharValue,                               // JT_INDEX[265]
  (uint32)GATT_WriteLongCharValue,                           // JT_INDEX[266]
  (uint32)GATT_WriteLongCharDesc,                            // JT_INDEX[267]
  (uint32)GATT_ReliableWrites,                               // JT_INDEX[268]
  (uint32)GATT_ReadCharDesc,                                 // JT_INDEX[269]
  (uint32)GATT_ReadLongCharDesc,                             // JT_INDEX[270]
  (uint32)GATT_WriteCharDesc,                                // JT_INDEX[271]
