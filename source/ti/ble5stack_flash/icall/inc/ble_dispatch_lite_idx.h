...
// <<INSERT:#if defined(CTRL_CONFIG) && (CTRL_CONFIG & (ADV_CONN_CFG | ADV_NCONN_CFG))>>
// <<BEGIN_COUNT>>
...
// <<END_COUNT>>
// <<INSERT:#else // !((ADV_CONN_CFG | ADV_NCONN_CFG))>>
// <<INSERT_LOOP:(uint32)icall_liteErrorFunction,>>
// <<INSERT:#endif // ADV_CONN_CFG | ADV_NCONN_CFG>>
...
// <<BEGIN_COUNT>>
#define IDX_GAP_UpdateLinkParamReq                       JT_INDEX(164)
#define IDX_GAP_TerminateLinkReq                         JT_INDEX(165)
#define IDX_GAP_UpdateLinkParamReqReply                  JT_INDEX(166)
#define IDX_GAP_Gap_RegisterConnEventCb                  JT_INDEX(167)
// <<END_COUNT>>
...
// <<BEGIN_COUNT>>
#define IDX_GapAdv_create                                JT_INDEX(168)
#define IDX_GapAdv_destroy                               JT_INDEX(169)
#define IDX_GapAdv_enable                                JT_INDEX(170)
#define IDX_GapAdv_disable                               JT_INDEX(171)
#define IDX_GapAdv_setParam                              JT_INDEX(172)
#define IDX_GapAdv_getParam                              JT_INDEX(173)
#define IDX_GapAdv_getBuffer                             JT_INDEX(174)
#define IDX_GapAdv_loadByHandle                          JT_INDEX(175)
#define IDX_GapAdv_loadByBuffer                          JT_INDEX(176)
#define IDX_GapAdv_prepareLoadByHandle                   JT_INDEX(177)
#define IDX_GapAdv_prepareLoadByBuffer                   JT_INDEX(178)
#define IDX_GapAdv_setEventMask                          JT_INDEX(179)
#define IDX_GapAdv_abortLoad                             JT_INDEX(180)
#define IDX_GapAdv_setVirtualAdvAddr                     JT_INDEX(181)
#define IDX_GapAdv_SetPeriodicAdvParams                  JT_INDEX(182)
#define IDX_GapAdv_SetPeriodicAdvData                    JT_INDEX(183)
#define IDX_GapAdv_SetPeriodicAdvEnable                  JT_INDEX(184)
// <<END_COUNT>>
...
// <<BEGIN_COUNT>>
#define IDX_GapScan_registerCb                           JT_INDEX(185)
#define IDX_GapScan_setPhyParams                         JT_INDEX(186)
#define IDX_GapScan_getPhyParams                         JT_INDEX(187)
#define IDX_GapScan_setParam                             JT_INDEX(188)
#define IDX_GapScan_getParam                             JT_INDEX(189)
#define IDX_GapScan_setEventMask                         JT_INDEX(190)
#define IDX_GapScan_enable                               JT_INDEX(191)
#define IDX_GapScan_disable                              JT_INDEX(192)
#define IDX_GapScan_getAdvReport                         JT_INDEX(193)
#define IDX_GapScan_discardAdvReportList                 JT_INDEX(194)
#define IDX_GapScan_PeriodicAdvCreateSync                JT_INDEX(195)
#define IDX_GapScan_PeriodicAdvCreateSyncCancel          JT_INDEX(196)
#define IDX_GapScan_PeriodicAdvTerminateSync             JT_INDEX(197)
#define IDX_GapScan_SetPeriodicAdvReceiveEnable          JT_INDEX(198)
#define IDX_GapScan_AddDeviceToPeriodicAdvList           JT_INDEX(199)
#define IDX_GapScan_RemoveDeviceFromPeriodicAdvList      JT_INDEX(200)
#define IDX_GapScan_ReadPeriodicAdvListSize              JT_INDEX(201)
#define IDX_GapScan_ClearPeriodicAdvList                 JT_INDEX(202)
// <<END_COUNT>>
...
// <<BEGIN_COUNT>>
#define IDX_GapInit_setPhyParam                          JT_INDEX(203)
#define IDX_GapInit_getPhyParam                          JT_INDEX(204)
#define IDX_GapInit_connect                              JT_INDEX(205)
#define IDX_GapInit_connectWl                            JT_INDEX(206)
#define IDX_GapInit_cancelConnect                        JT_INDEX(207)
// <<END_COUNT>>
...
// <<INSERT:#if defined(HOST_CONFIG)>>
// <<BEGIN_COUNT>>
#define IDX_GAP_TerminateAuth                            JT_INDEX(208)
#define IDX_GAP_Authenticate                             JT_INDEX(209)
#define IDX_GAP_PasskeyUpdate                            JT_INDEX(210)
#define IDX_GAP_Signable                                 JT_INDEX(211)
#define IDX_GAP_Bond                                     JT_INDEX(212)
#define IDX_GAP_SetPrivacyMode                           JT_INDEX(213)
// <<END_COUNT>>
// <<INSERT:#else // !(defined(HOST_CONFIG))>>
// <<INSERT_LOOP:(uint32)icall_liteErrorFunction,>>
// <<INSERT:#endif // defined(HOST_CONFIG)>>
...
// <<BEGIN_COUNT>>
#define IDX_GAP_SendSlaveSecurityRequest                 JT_INDEX(214)
// <<END_COUNT>>
...
/* RTLS Services API */
#define IDX_RTLSSrv_init                                JT_INDEX(215)
#define IDX_RTLSSrv_register                            JT_INDEX(216)
#define IDX_RTLSSrv_setConnCteReceiveParams             JT_INDEX(217)
#define IDX_RTLSSrv_setConnCteTransmitParams            JT_INDEX(218)
#define IDX_RTLSSrv_setConnCteRequestEnableCmd          JT_INDEX(219)
#define IDX_RTLSSrv_setConnCteResponseEnableCmd         JT_INDEX(220)
#define IDX_RTLSSrv_readAntennaInformationCmd           JT_INDEX(221)
#define IDX_RTLSSrv_setCteSampleAccuracy                JT_INDEX(222)
#define IDX_RTLSSrv_initAntArray                        JT_INDEX(223)
#define IDX_RTLSSrv_SetCLCteTransmitParams              JT_INDEX(224)
#define IDX_RTLSSrv_CLCteTransmitEnable                 JT_INDEX(225)
#define IDX_RTLSSrv_setCLCteSamplingEnableCmd           JT_INDEX(226)

/* L2CAP API */
/*************/
// <<INSERT:#if defined(HOST_CONFIG)>>
// <<BEGIN_COUNT>>
#define IDX_L2CAP_ConnParamUpdateReq                     JT_INDEX(227)
#define IDX_L2CAP_ParseParamUpdateReq                    JT_INDEX(228)
#define IDX_L2CAP_ParseInfoReq                           JT_INDEX(229)
// <<END_COUNT>>
// <<INSERT:#else // !defined(HOST_CONFIG)>>
// <<INSERT_LOOP:(uint32)icall_liteErrorFunction,>>
// <<INSERT:#endif // defined(HOST_CONFIG)>>
...
// <<BEGIN_COUNT>>
#define IDX_L2CAP_RegisterPsm                            JT_INDEX(230)
#define IDX_L2CAP_DeregisterPsm                          JT_INDEX(231)
#define IDX_L2CAP_PsmInfo                                JT_INDEX(232)
#define IDX_L2CAP_PsmChannels                            JT_INDEX(233)
#define IDX_L2CAP_ChannelInfo                            JT_INDEX(234)
#define IDX_L2CAP_SendSDU                                JT_INDEX(235)
#define IDX_L2CAP_ConnectReq                             JT_INDEX(236)
#define IDX_L2CAP_ConnectRsp                             JT_INDEX(237)
#define IDX_L2CAP_DisconnectReq                          JT_INDEX(238)
#define IDX_L2CAP_FlowCtrlCredit                         JT_INDEX(239)
// <<END_COUNT>>
...
// <<INSERT:#if ( HOST_CONFIG & ( CENTRAL_CFG | PERIPHERAL_CFG ))>>
// <<BEGIN_COUNT>>
#define IDX_L2CAP_RegisterFlowCtrlTask                   JT_INDEX(240)
// <<END_COUNT>>
// <<INSERT:#else // !( HOST_CONFIG & ( CENTRAL_CFG | PERIPHERAL_CFG ) )>>
// <<INSERT_LOOP:(uint32)icall_liteErrorFunction,>>
// <<INSERT:#endif // ( HOST_CONFIG & ( CENTRAL_CFG | PERIPHERAL_CFG ) )>>
...
// <<INSERT:#if ( defined(HOST_CONFIG) && ( defined(HCI_TL_FULL) && ( !defined(GATT_DB_OFF_CHIP) && defined(TESTMODES) )))>>
// <<BEGIN_COUNT>>
#define IDX_L2CAP_SetParamValue                          JT_INDEX(241)
#define IDX_L2CAP_GetParamValue                          JT_INDEX(242)
// <<END_COUNT>>
// <<INSERT:#else // !( defined(HOST_CONFIG) && ( defined(HCI_TL_FULL) && ( !defined(GATT_DB_OFF_CHIP) && defined(TESTMODES))  ))>>
// <<INSERT_LOOP:(uint32)icall_liteErrorFunction,>>
// <<INSERT:#endif // ( defined(HOST_CONFIG) && ( defined(HCI_TL_FULL) && ( !defined(GATT_DB_OFF_CHIP) && defined(TESTMODES))  ))>>
...
// <<BEGIN_COUNT>>
#define IDX_L2CAP_InfoReq                                JT_INDEX(243)
// <<END_COUNT>>
...
// <<INSERT:#if defined(HOST_CONFIG)>>
// <<BEGIN_COUNT>>
#define IDX_GATT_Indication                              JT_INDEX(244)
#define IDX_GATT_Notification                            JT_INDEX(245)
// <<END_COUNT>>
// <<INSERT:#else // !defined(HOST_CONFIG)>>
// <<INSERT_LOOP:(uint32)icall_liteErrorFunction,>>
// <<INSERT:#endif // defined(HOST_CONFIG)>>
...
// <<INSERT:#if ( HOST_CONFIG & ( CENTRAL_CFG | PERIPHERAL_CFG ))>>
// <<BEGIN_COUNT>>
#define IDX_GATT_RegisterForMsgs                         JT_INDEX(246)
#define IDX_GATT_UpdateMTU                               JT_INDEX(247)
#define IDX_GATT_SendRsp                                 JT_INDEX(248)
#define IDX_GATT_SetHostToAppFlowCtrl                    JT_INDEX(249)
#define IDX_GATT_AppCompletedMsg                         JT_INDEX(250)
// <<END_COUNT>>
// <<INSERT:#else // !( HOST_CONFIG & ( CENTRAL_CFG | PERIPHERAL_CFG ) )>>
// <<INSERT_LOOP:(uint32)icall_liteErrorFunction,>>
// <<INSERT:#endif // ( HOST_CONFIG & ( CENTRAL_CFG | PERIPHERAL_CFG ) )>>
...
// <<BEGIN_COUNT>>
#define IDX_GATT_InitClient                              JT_INDEX(251)
#define IDX_GATT_RegisterForInd                          JT_INDEX(252)
// <<END_COUNT>>
...
// <<BEGIN_COUNT>>
#define IDX_GATT_ExchangeMTU                             JT_INDEX(253)
#define IDX_GATT_DiscAllPrimaryServices                  JT_INDEX(254)
#define IDX_GATT_DiscPrimaryServiceByUUID                JT_INDEX(255)
#define IDX_GATT_DiscAllChars                            JT_INDEX(256)
#define IDX_GATT_DiscCharsByUUID                         JT_INDEX(257)
#define IDX_GATT_DiscAllCharDescs                        JT_INDEX(258)
#define IDX_GATT_ReadCharValue                           JT_INDEX(259)
#define IDX_GATT_ReadUsingCharUUID                       JT_INDEX(260)
#define IDX_GATT_ReadLongCharValue                       JT_INDEX(261)
#define IDX_GATT_ReadMultiCharValues                     JT_INDEX(262)
#define IDX_GATT_WriteNoRsp                              JT_INDEX(263)
#define IDX_GATT_SignedWriteNoRsp                        JT_INDEX(264)
#define IDX_GATT_WriteCharValue                          JT_INDEX(265)
#define IDX_GATT_WriteLongCharValue                      JT_INDEX(266)
#define IDX_GATT_WriteLongCharDesc                       JT_INDEX(267)
#define IDX_GATT_ReliableWrites                          JT_INDEX(268)
#define IDX_GATT_ReadCharDesc                            JT_INDEX(269)
#define IDX_GATT_ReadLongCharDesc                        JT_INDEX(270)
#define IDX_GATT_WriteCharDesc                           JT_INDEX(271)
// <<END_COUNT>>
...
// <<INSERT:#if ( HOST_CONFIG & ( PERIPHERAL_CFG ))>>
// <<BEGIN_COUNT>>
#define IDX_GATT_GetNextHandle                           JT_INDEX(272)
// <<END_COUNT>>
// <<INSERT:#else // !( HOST_CONFIG & ( PERIPHERAL_CFG ) )>>
// <<INSERT_LOOP:(uint32)icall_liteErrorFunction,>>
// <<INSERT:#endif // ( HOST_CONFIG & ( PERIPHERAL_CFG ) )>>
...
// <<INSERT:#if ( defined(HOST_CONFIG) && ( defined(HCI_TL_FULL) && ( !defined(GATT_DB_OFF_CHIP) && defined(TESTMODES) )))>>
// <<BEGIN_COUNT>>
#define IDX_GATT_PrepareWriteReq                         JT_INDEX(273)
#define IDX_GATT_ExecuteWriteReq                         JT_INDEX(274)
#define IDX_GATT_FindUUIDRec                             JT_INDEX(275)
#define IDX_GATT_RegisterService                         JT_INDEX(276)
#define IDX_GATT_DeregisterService                       JT_INDEX(277)
#define IDX_GATT_FindIncludedServices                    JT_INDEX(278)
// <<END_COUNT>>
// <<INSERT:#else // !( defined(HOST_CONFIG) && ( defined(HCI_TL_FULL) && ( !defined(GATT_DB_OFF_CHIP) && defined(TESTMODES))  ))>>
// <<INSERT_LOOP:(uint32)icall_liteErrorFunction,>>
// <<INSERT:#endif // ( defined(HOST_CONFIG) && ( defined(HCI_TL_FULL) && ( !defined(GATT_DB_OFF_CHIP) && defined(TESTMODES))  ))>>
...
// <<INSERT:#if ( defined(HOST_CONFIG) && ( defined(HCI_TL_FULL) ))>>
// <<BEGIN_COUNT>>
#define IDX_GATT_RegisterForReq                          JT_INDEX(279)
// <<END_COUNT>>
// <<INSERT:#else // !( defined(HOST_CONFIG) && ( defined(HCI_TL_FULL) ))>>
// <<INSERT_LOOP:(uint32)icall_liteErrorFunction,>>
// <<INSERT:#endif // ( defined(HOST_CONFIG) && ( defined(HCI_TL_FULL) ))>>
...
// <<INSERT:#if defined(HOST_CONFIG)>>
// <<BEGIN_COUNT>>
#define IDX_GATTServApp_RegisterService                  JT_INDEX(280)
#define IDX_GATTServApp_AddService                       JT_INDEX(281)
#define IDX_GATTServApp_DeregisterService                JT_INDEX(282)
#define IDX_GATTServApp_SetParameter                     JT_INDEX(283)
#define IDX_GATTServApp_GetParameter                     JT_INDEX(284)
#define IDX_GATTServApp_SendCCCUpdatedEvent              JT_INDEX(285)
// <<END_COUNT>>
// <<INSERT:#else // !defined(HOST_CONFIG)>>
// <<INSERT_LOOP:(uint32)icall_liteErrorFunction,>>
// <<INSERT:#endif // defined(HOST_CONFIG)>>
...
// <<BEGIN_COUNT>>
#define IDX_GATTServApp_SendServiceChangedInd            JT_INDEX(286)
// <<END_COUNT>>
...
// <<BEGIN_COUNT>>
#define IDX_GATTServApp_ReadRsp                          JT_INDEX(287)
// <<END_COUNT>>
...
// <<BEGIN_COUNT>>
#define IDX_GATTQual_AddService                          JT_INDEX(288)
// <<END_COUNT>>
...
// <<BEGIN_COUNT>>
#define IDX_GATTTest_AddService                          JT_INDEX(289)
// <<END_COUNT>>
...
// <<INSERT:#if ( defined(HOST_CONFIG) && ( defined(HCI_TL_FULL) && ( !defined(GATT_DB_OFF_CHIP) && defined(TESTMODES) )))>>
// <<BEGIN_COUNT>>
#define IDX_GATTServApp_GetParamValue                    JT_INDEX(290)
#define IDX_GATTServApp_SetParamValue                    JT_INDEX(291)
// <<END_COUNT>>
// <<INSERT:#else // !( defined(HOST_CONFIG) && ( defined(HCI_TL_FULL) && ( !defined(GATT_DB_OFF_CHIP) && defined(TESTMODES))  ))>>
// <<INSERT_LOOP:(uint32)icall_liteErrorFunction,>>
// <<INSERT:#endif // ( defined(HOST_CONFIG) && ( defined(HCI_TL_FULL) && ( !defined(GATT_DB_OFF_CHIP) && defined(TESTMODES))  ))>>
...
// <<INSERT:#if ( defined(HOST_CONFIG) && ( defined(HCI_TL_FULL) ))>>
// <<BEGIN_COUNT>>
#define IDX_GATTServApp_RegisterForMsg                   JT_INDEX(292)
// <<END_COUNT>>
// <<INSERT:#else // !( defined(HOST_CONFIG) && ( defined(HCI_TL_FULL)  ))>>
// <<INSERT_LOOP:(uint32)icall_liteErrorFunction,>>
// <<INSERT:#endif // ( defined(HOST_CONFIG) && ( defined(HCI_TL_FULL)   ))>>
...
// <<INSERT:#if defined(HOST_CONFIG)>>
// <<BEGIN_COUNT>>
#define IDX_linkDB_NumActive                             JT_INDEX(293)
#define IDX_linkDB_GetInfo                               JT_INDEX(294)
#define IDX_linkDB_State                                 JT_INDEX(295)
#define IDX_linkDB_NumConns                              JT_INDEX(296)
// <<END_COUNT>>
// <<INSERT:#else // !defined(HOST_CONFIG)>>
// <<INSERT_LOOP:(uint32)icall_liteErrorFunction,>>
// <<INSERT:#endif // defined(HOST_CONFIG)>>
...
// <<INSERT:#if defined(HOST_CONFIG)>>
// <<BEGIN_COUNT>>
#define IDX_SM_GetScConfirmOob                           JT_INDEX(297)
#define IDX_SM_GenerateRandBuf                           JT_INDEX(298)
#define IDX_SM_AuthenticatedPairingOnlyMode              JT_INDEX(299)
// <<END_COUNT>>
// <<INSERT:#else // !defined(HOST_CONFIG)>>
// <<INSERT_LOOP:(uint32)icall_liteErrorFunction,>>
// <<INSERT:#endif // defined(HOST_CONFIG)>>
...
// <<INSERT:#if defined(HOST_CONFIG)>>
// <<BEGIN_COUNT>>
#define IDX_SM_GetEccKeys                                JT_INDEX(300)
#define IDX_SM_GetDHKey                                  JT_INDEX(301)
#define IDX_SM_RegisterTask                              JT_INDEX(302)
// <<END_COUNT>>
// <<INSERT:#else // !(defined(HOST_CONFIG))>>
// <<INSERT_LOOP:(uint32)icall_liteErrorFunction,>>
...
// <<INSERT:#if defined(HOST_CONFIG)>>
// <<BEGIN_COUNT>>
#define IDX_ATT_ErrorRsp                                 JT_INDEX(303)
#define IDX_ATT_ReadBlobRsp                              JT_INDEX(304)
#define IDX_ATT_ExecuteWriteRsp                          JT_INDEX(305)
#define IDX_ATT_WriteRsp                                 JT_INDEX(306)
#define IDX_ATT_ReadRsp                                  JT_INDEX(307)
// <<END_COUNT>>
// <<INSERT:#else // !defined(HOST_CONFIG)>>
// <<INSERT_LOOP:(uint32)icall_liteErrorFunction,>>
// <<INSERT:#endif // defined(HOST_CONFIG)>>
...
// <<INSERT:#if ( defined(HOST_CONFIG) && defined(HCI_TL_FULL))>>
// <<BEGIN_COUNT>>
#define IDX_ATT_ParseExchangeMTUReq                      JT_INDEX(308)
#define IDX_ATT_ExchangeMTURsp                           JT_INDEX(309)
#define IDX_ATT_FindInfoRsp                              JT_INDEX(310)
#define IDX_ATT_FindByTypeValueRsp                       JT_INDEX(311)
#define IDX_ATT_ReadByTypeRsp                            JT_INDEX(312)
#define IDX_ATT_ReadMultiRsp                             JT_INDEX(313)
#define IDX_ATT_ReadByGrpTypeRsp                         JT_INDEX(314)
#define IDX_ATT_PrepareWriteRsp                          JT_INDEX(315)
// <<END_COUNT>>
// <<INSERT:#else // !defined(HOST_CONFIG)>>
// <<INSERT_LOOP:(uint32)icall_liteErrorFunction,>>
// <<INSERT:#endif // defined(HOST_CONFIG)>>
...
// <<INSERT:#if defined(HOST_CONFIG) && !defined(GATT_NO_CLIENT)>>
// <<BEGIN_COUNT>>
#define IDX_ATT_HandleValueCfm                           JT_INDEX(316)
// <<END_COUNT>>
// <<INSERT:#else // !(defined(HOST_CONFIG) && !defined(GATT_NO_CLIENT) )>>
// <<INSERT_LOOP:(uint32)icall_liteErrorFunction,>>
// <<INSERT:#endif // (defined(HOST_CONFIG) && !defined(GATT_NO_CLIENT) )>>
...
// <<INSERT:#if ( defined(HOST_CONFIG) && ( defined(HCI_TL_FULL) && ( !defined(GATT_DB_OFF_CHIP) && defined(TESTMODES) )))>>
// <<BEGIN_COUNT>>
#define IDX_ATT_SetParamValue                            JT_INDEX(317)
#define IDX_ATT_GetParamValue                            JT_INDEX(318)
// <<END_COUNT>>
// <<INSERT:#else // !( defined(HOST_CONFIG) && ( defined(HCI_TL_FULL) && ( !defined(GATT_DB_OFF_CHIP) && defined(TESTMODES))  ))>>
// <<INSERT_LOOP:(uint32)icall_liteErrorFunction,>>
// <<INSERT:#endif // ( defined(HOST_CONFIG) && ( defined(HCI_TL_FULL) && ( !defined(GATT_DB_OFF_CHIP) && defined(TESTMODES))  ))>>
...
/* SNV API */
/***********/
#define IDX_osal_snv_read                                JT_INDEX(319)
#define IDX_osal_snv_write                               JT_INDEX(320)

/* UTIL API */
/************/
// <<INSERT:#if !defined(HCI_TL_NONE)>>
// <<BEGIN_COUNT>>
#define IDX_NPI_RegisterTask                             JT_INDEX(321)
// <<END_COUNT>>
...
// <<INSERT:in the table */>>
#define IDX_buildRevision                                JT_INDEX(322)
