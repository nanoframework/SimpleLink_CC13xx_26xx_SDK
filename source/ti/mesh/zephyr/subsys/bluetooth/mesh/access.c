...
s32_t bt_mesh_model_pub_period_get(struct bt_mesh_model *mod)
{
	...
	case 0x01:
		/* 1 step is 1 second */
		period = K_SECONDS((int)(mod->pub->period & BIT_MASK(6)));
		break;
	case 0x02:
		/* 1 step is 10 seconds */
		period = K_SECONDS((int)((mod->pub->period & BIT_MASK(6)) * 10U));
		break;
	case 0x03:
		/* 1 step is 10 minutes */
		period = K_MINUTES((int)((mod->pub->period & BIT_MASK(6)) * 10U));
		break;
	default:
		CODE_UNREACHABLE;
	}
...
#pragma diag_group_id 994
#elif defined(__IAR_SYSTEMS_ICC__)
#pragma diag_suppress=Pe940 // Suppress warning "missing return statement at end of non-void get_opcode"
#else
