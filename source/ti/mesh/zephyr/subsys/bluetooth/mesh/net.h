...
#if !(defined(__IAR_SYSTEMS_ICC__) && FRIEND_SUB_LIST_SIZE==0 )
	uint16_t sub_list[FRIEND_SUB_LIST_SIZE];
#endif /* !(defined(__IAR_SYSTEMS_ICC__) && FRIEND_SUB_LIST_SIZE==0 ) */

	struct k_delayed_work timer;

#if !(defined(__IAR_SYSTEMS_ICC__) && FRIEND_SEG_RX==0 )
...
#endif /* !(defined(__IAR_SYSTEMS_ICC__) && FRIEND_SEG_RX==0 ) */
...
#if !(defined(__IAR_SYSTEMS_ICC__) && LPN_GROUPS==0 )
	/* Subscribed groups */
	uint16_t groups[LPN_GROUPS];
#endif /* !(defined(__IAR_SYSTEMS_ICC__) && LPN_GROUPS==0 ) */
