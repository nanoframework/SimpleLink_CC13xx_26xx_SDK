...
#endif /* defined(CONFIG_BT_MESH_PB_ADV) && defined(CONFIG_BT_MESH_PROVISIONER) */
...
#pragma diag_group_id 112, 552
#elif defined(__ti__) || defined(__TI_COMPILER_VERSION__)
