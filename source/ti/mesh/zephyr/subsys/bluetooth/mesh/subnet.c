...
#pragma section="bt_mesh_subnet_cb_area"
#endif /* __IAR_SYSTEMS_ICC__ */

/* Suppress warning: Statement is unreachable at bt_mesh_subnet_node_id_set */
				   ...
				   enum bt_mesh_feat_state *node_id)
{
	...
	sub = bt_mesh_subnet_get(net_idx);
	if (!sub) {
		*node_id = (enum bt_mesh_feat_state) 0x00;
		return STATUS_INVALID_NETKEY;
	}

	*node_id = (enum bt_mesh_feat_state) sub->node_id;
