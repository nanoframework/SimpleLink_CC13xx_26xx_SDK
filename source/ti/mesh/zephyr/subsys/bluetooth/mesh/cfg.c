...
/* Suppress warning: "Statement is unreachable" at:
 *  bt_mesh_gatt_proxy_set, bt_mesh_gatt_proxy_get,
 *  bt_mesh_friend_set, bt_mesh_friend_get,
 *  bt_mesh_relay_set, bt_mesh_relay_retransmit_get
 */
		   ...
		   settings_read_cb read_cb, void *cb_arg)
{
	...
	bt_mesh_relay_set((enum bt_mesh_feat_state) cfg.relay, cfg.relay_retransmit);
	bt_mesh_beacon_set(cfg.beacon);
	bt_mesh_gatt_proxy_set((enum bt_mesh_feat_state) cfg.gatt_proxy);
	bt_mesh_friend_set((enum bt_mesh_feat_state) cfg.frnd);
