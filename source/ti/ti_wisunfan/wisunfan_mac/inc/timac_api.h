...
#ifndef MAC_KEY_ID_MODE_IMPLICIT
...
#define MAC_FH_FC_IE            0x00000001 /* Bit to include FC IE */
...
#define MAC_FH_EA_IE            0x00000010 /* Bit to include EA IE */
...
#define MAC_FH_VP_IE            0x00400000
#define MAC_FH_MPX_IE           0x00800000
...
typedef struct
{
  ...
  uint8*    pHeaderIE;        /* Pointer to the start of header IEs */
  uint16    headerIeLen;      /* length of header ie if any */
#endif
