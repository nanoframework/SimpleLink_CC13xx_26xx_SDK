...
/* global variables */
   ...
   (uint32)NULL,                                         //ROM_HMAC_JT_OFFSET[30]
   (uint32)NULL,                                         //ROM_HMAC_JT_OFFSET[31]
   (uint32)NULL,
   (uint32)NULL,                                         //ROM_HMAC_JT_OFFSET[33]
#else
  ...
  // (uint32)&freqHopEnabled,                              //ROM_HMAC_JT_OFFSET[46]
   ...
   (uint32)NULL,                                         //ROM_HMAC_JT_OFFSET[52]
...
//   (uint32)&MAC_MlmeSetActivePib,                        //ROM_HMAC_JT_OFFSET[202]
   ...
   (uint32)NULL,                                         //ROM_HMAC_JT_OFFSET[200]
