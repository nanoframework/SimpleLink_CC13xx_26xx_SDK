...
#else
extern void FHIE_genUTIE(uint8_t *pBuf, uint8_t fhFrameType, uint32_t offset);
extern void FHIE_genBTIE(uint8_t *pBuf, uint8_t frameType, uint32_t offset);
#endif
...
extern uint16_t FHIE_genPie(uint8_t *pData, uint32_t bitmap, macTx_t *pMacTx, FHIE_ieInfo_new_t *pIeInfo);
extern uint16_t FHIE_genHie(uint8_t *pData, uint32_t bitmap, macTx_t *pMacTx, FHIE_ieInfo_new_t *pIeInfo);
...
extern void FHDATA_compEDFEReq(uint8_t status);
#endif
...
const uint32 FH_ROM_Flash_JT[] =
{
    ...
    (uint32)NULL,                                    //ROM_FH_JT_OFFSET[90]
    (uint32)NULL,                                    //ROM_FH_JT_OFFSET[91]
    (uint32)NULL,                                    //ROM_FH_JT_OFFSET[92]
    (uint32)NULL,                                    //ROM_FH_JT_OFFSET[93]
#else
...
#ifdef FEATURE_WISUN_EDFE_SUPPORT
    (uint32)&FHDATA_compEDFEReq,                             //ROM_FH_JT_OFFSET[135]
#else
    (uint32)NULL,                                            //ROM_FH_JT_OFFSET[135]
#endif
