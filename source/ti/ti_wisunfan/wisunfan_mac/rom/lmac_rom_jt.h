...
#define MAP_macRadioSendEDFEEfrm                            ((void    (*)(sAddr_t *, ApiMac_sec_t *, uint8))    ROM_LMAC_JT_OFFSET(LMAC_API_BASE_INDEX+44))
#define MAP_macRadioTxEDFEEfrmCb                            ((void    (*)(macTx_t *))                           ROM_LMAC_JT_OFFSET(LMAC_API_BASE_INDEX+45))
#endif
