...
#define MAP_FHAPI_setStateCb                ((void  (*)(FH_LMAC_STATUS_t))     ROM_FH_JT_OFFSET(FH_API_BASE_INDEX+11))
#define MAP_FHAPI_SFDRxCb                   ((void  (*)(uint8_t))              ROM_FH_JT_OFFSET(FH_API_BASE_INDEX+12))

/* file: fh_data.c */
#define MAP_FHDATA_checkPktFromQueue        ((MAP_osal_msg_q_t  (*)(MAP_osal_msg_q_t *,uint8_t))    ROM_FH_JT_OFFSET(FH_API_BASE_INDEX+13))
#define MAP_FHDATA_getPktFromQueue          ((MAP_osal_msg_q_t  (*)(MAP_osal_msg_q_t *,uint8_t))    ROM_FH_JT_OFFSET(FH_API_BASE_INDEX+14))
#define MAP_FHDATA_purgePktFromQueue        ((FHAPI_status  (*)(MAP_osal_msg_q_t *,uint8_t))    ROM_FH_JT_OFFSET(FH_API_BASE_INDEX+15))
#define MAP_FHDATA_purgeUnSupportedFrameTypes ((void  (*)(MAP_osal_msg_q_t *))                  ROM_FH_JT_OFFSET(FH_API_BASE_INDEX+16))
...
#else
#define MAP_FHIE_genUTIE                    ((void  (*)(uint8_t *, uint8_t, uint32_t))          ROM_FH_JT_OFFSET(FH_API_BASE_INDEX+35))
#define MAP_FHIE_genBTIE                    ((void  (*)(uint8_t *, uint8_t, uint32_t ))         ROM_FH_JT_OFFSET(FH_API_BASE_INDEX+36))
#endif
...
#else
#define MAP_FHIE_genPie                     ((uint16_t  (*)(uint8_t *, uint32_t, macTx_t *,FHIE_ieInfo_new_t *))          ROM_FH_JT_OFFSET(FH_API_BASE_INDEX+44))
#define MAP_FHIE_genHie                     ((uint16_t  (*)(uint8_t *, uint32_t, macTx_t *,FHIE_ieInfo_new_t *))          ROM_FH_JT_OFFSET(FH_API_BASE_INDEX+45))
#endif
...
#define MAP_FHNT_AddDeviceCB                ((uint16_t (*)(sAddrExt_t *,uint16_t))                ROM_FH_JT_OFFSET(FH_API_BASE_INDEX+88))
#define MAP_FHNT_DelDeviceCB                ((uint16_t (*)(sAddrExt_t *,uint16_t))                ROM_FH_JT_OFFSET(FH_API_BASE_INDEX+89))
...
/* fh_api.c */
#define MAP_FHAPI_getBitCount               ((uint8_t (*)(void ))                                              ROM_FH_JT_OFFSET(FH_API_BASE_INDEX+125))
...
#else
#define MAP_FHIEPATCH_genHie                ((uint16_t  (*)(uint8_t *, uint32_t , macTx_t *, FHIE_ieInfo_new_t * ))             ROM_FH_JT_OFFSET(FH_API_BASE_INDEX+132))
#endif
...
#define MAP_FHDATA_compEDFEReq              ((void (*)(uint8_t))                                            ROM_FH_JT_OFFSET(FH_API_BASE_INDEX+135))
#endif
