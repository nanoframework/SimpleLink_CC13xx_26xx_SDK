/*******************************************************************************
  Filename:       mac.c
  Revised:        $Date: 2015-02-27 09:28:37 -0800 (Fri, 27 Feb 2015) $
  Revision:       $Revision: 43020 $
...
static uint8 macSynchRadioCommand(rfOpCmd_t *pCmd)
{
  ...
  /* Keep submitting the command until scheduled or busy */
 ...
 **************************************************************************************************
 */
void macCheckCommandDone(rfOpCmd_t *rfOpCmd)
{
