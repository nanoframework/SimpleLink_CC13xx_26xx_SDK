...
#define MAC_TX_ACTIVE_LISTEN_FOR_EDFE      (0x08 | MAC_TX_ACTIVE_PHYSICALLY_BV)
#define MAC_TX_ACTIVE_LISTEN_FOR_RFRM      (0x09 | MAC_TX_ACTIVE_PHYSICALLY_BV)
#define MAC_TX_ACTIVE_POST_EDFE            (0x0a | MAC_TX_ACTIVE_PHYSICALLY_BV)
...
MAC_INTERNAL_API void macTxEDFEIsr(uint8 frameType);
#endif //FEATURE_WISUN_MIN_EDFE
#else
MAC_INTERNAL_API void macTxEDFEReplyCallback(uint8 txFrameType);
MAC_INTERNAL_API void macTxUpdateIE(macTx_t *pData);
MAC_INTERNAL_API void macTxEDFEIsr(uint8 frameType);
#endif
