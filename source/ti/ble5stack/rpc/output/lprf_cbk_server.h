...
private:
    ...
    /*! @brief Server shim for settings_commit_cb of BLEmesh_cbk_access interface. */
    erpc_status_t settings_commit_cb_shim(erpc::Codec * codec, erpc::MessageBufferFactory *messageFactory, uint32_t sequence);
#endif
    ...
    /*! @brief Server shim for hb_sub_cb of BLEmesh_cbk_access interface. */
    erpc_status_t hb_sub_cb_shim(erpc::Codec * codec, erpc::MessageBufferFactory *messageFactory, uint32_t sequence);
#endif
};
...
private:
    ...
    /*! @brief Server shim for lpn_set_cb of BLEmesh_cbk interface. */
    erpc_status_t lpn_set_cb_shim(erpc::Codec * codec, erpc::MessageBufferFactory *messageFactory, uint32_t sequence);
#endif
};
