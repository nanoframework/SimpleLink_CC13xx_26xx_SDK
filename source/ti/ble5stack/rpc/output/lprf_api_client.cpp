...
//! @brief Function to write struct bt_mesh_hb_sub_raw
static void write_bt_mesh_hb_sub_raw_struct(erpc::Codec * codec, const bt_mesh_hb_sub_raw * data);

//! @brief Function to write struct bt_mesh_cfg_srv_raw
static void write_bt_mesh_cfg_srv_raw_struct(erpc::Codec * codec, const bt_mesh_cfg_srv_raw * data);

//! @brief Function to write struct bt_mesh_hb_pub_raw
static void write_bt_mesh_hb_pub_raw_struct(erpc::Codec * codec, const bt_mesh_hb_pub_raw * data);
...
static void write_bt_mesh_model_cb_raw_struct(erpc::Codec * codec, const bt_mesh_model_cb_raw * data)
{
    ...
    {
        codec->writeNullFlag(false);
        codec->writeCallback((funPtr)(settings_commit_cb), (funPtr)(data->settings_commit));
    }
...
// Write struct bt_mesh_hb_sub_raw function implementation
static void write_bt_mesh_hb_sub_raw_struct(erpc::Codec * codec, const bt_mesh_hb_sub_raw * data)
{
    codec->write(data->expiry);
    ...
    {
        codec->writeNullFlag(false);
        codec->writeCallback((funPtr)(hb_sub_cb), (funPtr)(data->func));
    }
}

// Write struct bt_mesh_cfg_srv_raw function implementation
static void write_bt_mesh_cfg_srv_raw_struct(erpc::Codec * codec, const bt_mesh_cfg_srv_raw * data)
{
    codec->write(data->model_placeholder);

    codec->write(data->net_transmit);

    codec->write(data->relay);

    codec->write(data->relay_retransmit);

    codec->write(data->beacon);

    codec->write(data->gatt_proxy);

    codec->write(data->frnd);

    codec->write(data->default_ttl);
    ...
    {
        codec->writeNullFlag(false);
        write_bt_mesh_hb_pub_raw_struct(codec, &(*data->hb_pub));
    }
    ...
    {
        codec->writeNullFlag(false);
        write_bt_mesh_hb_sub_raw_struct(codec, &(*data->hb_sub));
    }
}

// Write struct bt_mesh_hb_pub_raw function implementation
static void write_bt_mesh_hb_pub_raw_struct(erpc::Codec * codec, const bt_mesh_hb_pub_raw * data)
{
    codec->write(data->timer_placeholder);
...
int32_t bt_mesh_cfg_srv_raw_init(uint16_t elem_index, const bt_mesh_cfg_srv_raw * cfg_srv)
{
    erpc_status_t err = kErpcStatus_Success;
    ...
    else
    {
        ...
        write_bt_mesh_cfg_srv_raw_struct(codec, cfg_srv);
...
// BLEmesh_api interface bt_mesh_lpn_set_cb function client shim.
void bt_mesh_lpn_set_cb(BLEmesh_cb cb)
{
    erpc_status_t err = kErpcStatus_Success;
    ...
    {
        codec->startWriteMessage(kInvocationMessage, kBLEmesh_api_service_id, kBLEmesh_api_bt_mesh_lpn_set_cb_id, request.getSequence());
        ...
        {
            codec->writeNullFlag(false);
            codec->writeCallback((funPtr)(lpn_set_cb), (funPtr)(cb));
        }
    ...
    // Invoke error handler callback function
    lprf_api_cm->callErrorHandler(err, kBLEmesh_api_bt_mesh_lpn_set_cb_id);
